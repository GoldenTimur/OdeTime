...
public class Main extends Game implements Interface {
	...
	public static Texture PlayOut,Play , Name, Scene1, Scene2, circle1, circle2, circle3, actor1, actor1_1, actor2, actor3, actor4, actor5, actorFight1, actorFight1_1, actorFight2, actorFight2_1, actorFight3, actorFight3_1, actorFight4, actorFight5, Load, Box1, WallLiane1;
	...
	public void create () {
		...
		Scene2 = new Texture("Grass2_1.png");
		...
		gameSc = new GameSc(this, joy, fig, player, scene, playButton, name, start, load, box, wallLiane);
		setScreen(gameSc);
	}
