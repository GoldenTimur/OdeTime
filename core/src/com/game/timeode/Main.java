...
public class Main extends Game implements Interface {
	...
	public static Texture OldTime, PlayOut,Play , Name, Scene1, Scene2, circle1, circle2, circle3, actor1, actor1_1, actor2, actor3, actor4, actor5, actorFight1, actorFight1_1, actorFight2, actorFight2_1, actorFight3, actorFight3_1, actorFight4, actorFight5, Load, Box1, Box2, Box3, Box4, Box5, Box6, WallLiane1, Plane1, Water1, Water2, Pit1, Pit2;
	...
	public void create () {
		...
		gameSc = new GameSc(this, joy, fig, player, scene, scene2, playButton, name, start, load, box, wallLiane, plate, pit, time);
		setScreen(gameSc);
	}
